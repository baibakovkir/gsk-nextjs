...
const faqdata = [
  {
    question: "Реестр достижений",
    answer: "В реестре можно найти актуальную информацию о сортах, допущенных к использоованию",
  },
  {
    question: "Документы",
    answer: "В разделе Документы можно посмотреть уставную, ведомственную, локальную и международную документацию",
  },
];
